...
function createInvalid (flags) {
    var m = createUTC(NaN);
    if (flags != null) {
        extend$4(getParsingFlags(m), flags);
    }
    else {
...
function mergeConfigs(parentConfig, childConfig) {
    var res = extend$4({}, parentConfig), prop;
    for (prop in childConfig) {
        if (hasOwnProp(childConfig, prop)) {
            if (isObject$3(parentConfig[prop]) && isObject$3(childConfig[prop])) {
                res[prop] = {};
                extend$4(res[prop], parentConfig[prop]);
                extend$4(res[prop], childConfig[prop]);
...
function configFromStringAndArray(config) {
    ...
    extend$4(config, bestMoment || tempConfig);
}
...
var Form$2;
var extend$7 = function(child, parent) { for (var key in parent) { if (hasProp$5.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
var hasProp$5 = {}.hasOwnProperty;

Form$2 = (function(superClass) {
  extend$7(Form, superClass);
...
var CheckoutForm;
var extend$6 = function(child, parent) { for (var key in parent) { if (hasProp$4.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
DepositForm = (function(superClass) {
  extend$5(DepositForm, superClass);
...
RegisterForm = (function(superClass) {
  extend$10(RegisterForm, superClass);
...
RegisterCompleteForm = (function(superClass) {
  extend$11(RegisterCompleteForm, superClass);
...
ResetPasswordForm = (function(superClass) {
  extend$12(ResetPasswordForm, superClass);
...
ResetPasswordCompleteForm = (function(superClass) {
  extend$13(ResetPasswordCompleteForm, superClass);
...
var CheckBox$1 = CheckBox = (function(superClass) {
  ...
  CheckBox.prototype.html = html$9;
...
TextBox = (function(superClass) {
  ...
  TextBox.prototype.html = html$10;
...
Currency = (function(superClass) {
  ...
  Currency.prototype.html = html$12;
...
Coin.mount = function() {
  ...
  Promise$2.settle(ps).then(function() {
    requestAnimationFrame(function() {
      ...
      return m.trigger(Events$4.Ready);
    });
    return El$1.scheduleUpdate();
  })["catch"](function(err) {
    var ref2;
